        ...
        <div class="react-wrapper-inner">
            ...
            <div class="react-breadcrumbs">
                <div class="breadcrumbs-wrap">
                    <img class="desktop" src="{{ URL::asset('build/images/breadcrumbs/1-back.jpg') }}" alt="Breadcrumbs">
                    <img class="mobile" src="{{ URL::asset('build/images/breadcrumbs/1-back.jpg') }}" alt="Breadcrumbs">
