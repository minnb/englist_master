        ...
        <div class="tab-content">
            <div id="Discription" class="tab-pane fade in active">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input type="number" name="duration" class="col-xs-10 col-sm-5" required value="{{ old('duration', isset($data) ? $data['sales'] : '')}}" required />
                    </div>
                    <div class="col-xs-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9">
                        <textarea name="description" id="description" rows="6" class="col-xs-9 col-sm-5">{{ old('description', isset($data) ? $data['desc'] : '')}}</textarea>
                    </div>
                </div>
                <div class="form-group">
