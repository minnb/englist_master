...
<div class="tabbable">
    <ul class="nav nav-tabs" id="myTab">
        ...
        <li>
            <a href="{{ route('get.dashboard.feedback.create') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons">
                                <a class="green" href="{{ route('get.dashboard.feedback.edit', ['id'=>$item->id]) }}">
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        <li>
                                            <a href="{{ route('get.dashboard.feedback.edit', ['id'=>$item->id]) }}" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                <span class="green">
